                                ...
                                <table className="table table-bordered mb-0">
                                    ...
                                    {data && data.map((d, key) =>
                                        <tr key={d.id}>
                                            ...
                                            <td>
                                            <Link to={`/patientbill/add`} className='btn btn-primary' ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-file-earmark-arrow-down-fill" viewBox="0 0 16 16">
