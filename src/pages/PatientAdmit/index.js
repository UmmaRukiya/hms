                                ...
                                <table className="table table-bordered mb-0">
                                    ...
                                    {data && data.map((d, key) =>
                                        <tr key={d.id}>
                                            ...
                                            <td>
                                            <Link to={`/patienttest/add/${d.id}/${d.patient_id}`} className='btn btn-primary' >Test</Link>
                                            {d.release_date && (

                                            <Link to={`/patientbill/add/${d.id}/${d.patient_id}`} className='btn btn-info' >Bill</Link>
                                            )}
