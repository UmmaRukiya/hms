...
function Nurse() {
    ...
    const getDatas = async (e) => {
        let res = await axios.get(`/nurse/index`)
        setData(res.data.data);

    }
    const deleteData = async (id) => {
        let res = await axios.delete(`/nurse/${id}`)
        getDatas();
                ...
                <div className="col-12">
                    <div className="card">
                        <div className="card-header">
                            <h4 className="card-title">All Nurse</h4>
                                ...
                                <table className="table table-bordered mb-0">
                                    ...
                                    {data && data.map((d, key) =>
                                        <tr key={d.id}>
                                            ...
                                            <td>{d.status}</td>
                                            <td>
                                            <Link to={`/nurse/edit/${d.id}`} className='btn btn-info' ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-pencil-square" viewBox="0 0 16 16">
