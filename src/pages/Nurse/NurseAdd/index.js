                    ...
                    <div className="col-12">
                        <div className="card">
                            <div className="card-content">
                                ...
                                <div className="col-md-4 form-group">
                                    <input type="gender" id="email-id" className="form-control" name="gender" defaultValue={inputs.gender}  onChange={handleChange} placeholder="Gender"/>
                                </div>
                                <div className="col-md-2">
                                    <label>Email</label>
                                </div>
                                ...
                                <div className="col-md-4 form-group">
                                    <input type="status" id="password" className="form-control" name="status" defaultValue={inputs.status}  onChange={handleChange} placeholder="Status"/>
                                </div>
                                <div className="col-md-2">
                                    <label>Present Address</label>
                                </div>
                                <div className="col-md-10 form-group">
                                    <textarea rows="3"cols="50" defaultValue={inputs.present_address}  onChange={handleChange} placeholder="Type your present address here..."/>
                                ...
                                <div className="col-md-10 form-group">
                                <textarea rows="3"cols="50" defaultValue={inputs.name}  onChange={handleChange} placeholder="Type your permanent address here..."/>
                                </div>
                                <div className="col-md-2">
                                    <label>Status</label>
                                </div>
