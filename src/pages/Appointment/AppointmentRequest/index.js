...
function AppointmentRequest() {
    ...
    function getDatas() {
        axios.get(`${process.env.REACT_APP_API_URL}/appointmentrequest/index`).then(function(response) {
                                    ...
                                    {data && data.map((d, key) =>
                                        <tr key={d.id}>
                                            ...
                                            <td>
                                                ...
                                                <Link to={`/appointmentrequest/edit/${d.id}`} className='btn btn-info' ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-pencil-square" viewBox="0 0 16 16">
